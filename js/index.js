...
function prevSlide() {
  ...
  if (currentIndex > 0) {
    ...
    trocarCarrossel(carrosselIds[anterior], true) // true = vai para último slide
  }
}

function startSlideShow() {
  if (slideInterval) clearInterval(slideInterval)
  slideInterval = setInterval(() => nextSlide(false), intervalTime)
}
...
function trocarCarrossel(tipo, irParaUltimo = false) {
  ...
  // Atualiza indicador dentro do carrossel
